...
class TopTradersDayScreen extends StatelessWidget {
  TopTradersDayScreen({super.key});

  final formatter = NumberFormat("#,##0");

  String getInitials(String fullName) {
    return fullName.isNotEmpty
        ? fullName.split(" ").map((eachName) => eachName[0]).join(".")
        : "";
  }
                          ...
                          child: ListView.separated(
                            ...
                            itemBuilder: (BuildContext context, int index) {
                              return ListTile(
                                ...
                                subtitle: Text(
                                  controller
                                      .topTraders[index + 3].user!.username!,
                                  style: const TextStyle(
                                    color: Colors.grey,
                                    fontSize: 12.0,
                                    fontWeight: FontWeight.w500,
