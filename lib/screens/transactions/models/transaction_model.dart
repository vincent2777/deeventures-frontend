...
class Transaction {
  ...
  factory Transaction.fromJson(Map<String, dynamic> json) => Transaction(
    id: json["id"],
    userId: json["user_id"],
    trnxAmount: double.parse(json["trnx_amount"].toString()),
    ...
    trnxStatus: int.parse(json["trnx_status"].toString()),
    trnxRate: double.parse(json["trnx_rate"].toString()),
    trnxAddress: json["trnx_address"],
    trnxImage: json["trnx_image"],
    toReceive: double.parse(json["to_receive"].toString()),
